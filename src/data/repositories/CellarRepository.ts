...
function mapReport(dto?: WineReportDto | null): WineReport | undefined {
  ...
  return {
    ...
    sensoryAnalysis: dto.sensory_analysis,
    visualAnalysis: dto.visual_analysis,
    olfactoryAnalysis: dto.olfactory_analysis,
    palateAnalysis: dto.palate_analysis,
    oakInfluence: dto.oak_influence,
    tanninLevel: dto.tannin_level,
